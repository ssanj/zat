...
![Select a choice](../../images/zat-choices-2.gif)
...
Also note that choices will be displayed first, before all other variables. This is because what variables are displayed next can depend on the choices taken and the scopes added to subsequent variables. See [scopes](scopes.md) for more information.
